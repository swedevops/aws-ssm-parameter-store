...
parameters = [
  ...
  { name = "prod.user.redis_host", value = "elasticache-dev-elasticache-001.eua4rj.0001.use1.cache.amazonaws.com" },
  { name = "prod.user.mongo_endpoint", value = "mongodb-prod.swedev99.online" },
  {  name = "prod.cart.redis_host", value = "elasticache-dev-elasticache-001.eua4rj.0001.use1.cache.amazonaws.com" },
  ...
  { name = "prod.rds.db_host", value = "rds-dev-rds.cluster-cjfgr880brvd.us-east-1.rds.amazonaws.com" },
  ...
  { name = "prod.docdb.db_endpoint", value = "docdb-dev.cluster-cjfgr880brvd.us-east-1.docdb.amazonaws.com" }
...
passwords = [
  ...
  { name = "prod.catalogue.mongo_url", value = "mongodb://roboshop:roboshop123456@docdb-dev.cluster-cjfgr880brvd.us-east-1.docdb.amazonaws.com:27017/catalogue?tls=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false" },
  { name = "prod.user.mongo_url", value = "mongodb://roboshop:roboshop123456@docdb-dev.cluster-cjfgr880brvd.us-east-1.docdb.amazonaws.com:27017/users?tls=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false" }
]
