...
parameters = [
  ...
  { name = "dev.user.redis_host", value = "elasticache-dev-elasticache-001.cjanfz.0001.use1.cache.amazonaws.com" },
  { name = "dev.user.mongo_endpoint", value = "mongodb-dev.swedev99.online" },
  {  name = "dev.cart.redis_host", value = "elasticache-dev-elasticache-001.cjanfz.0001.use1.cache.amazonaws.com" },
  ...
  { name = "dev.rds.db_host", value = "rds-dev-rds.cluster-cgwqtr8vszmk.us-east-1.rds.amazonaws.com" },
  ...
  { name = "dev.docdb.db_endpoint", value = "docdb-dev.cluster-cgwqtr8vszmk.us-east-1.docdb.amazonaws.com" }
...
passwords = [
  ...
  { name = "dev.catalogue.mongo_url", value = "mongodb://roboshop:roboshop123456@docdb-dev.cluster-cgwqtr8vszmk.us-east-1.docdb.amazonaws.com:27017/catalogue?tls=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false" },
  { name = "dev.user.mongo_url", value = "mongodb://roboshop:roboshop123456@docdb-dev.cluster-cgwqtr8vszmk.us-east-1.docdb.amazonaws.com:27017/users?tls=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false" }
 ]
